...
#include "RTAbilitySet.h"

#include "Core/RTAbilitySystemComponent.h"
...
void FAbilitySet_GrantedHandles::TakeFromAbilitySystem(URTAbilitySystemComponent* ASC)
{
	check(ASC);
...
void URTAbilitySet::GiveToAbilitySystem(URTAbilitySystemComponent* ASC, FAbilitySet_GrantedHandles* OutGrantedHandles,
