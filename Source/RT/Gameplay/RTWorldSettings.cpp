...
ARTWorldSettings::ARTWorldSettings(const FObjectInitializer& ObjInit) : Super(ObjInit)
{
}

FPrimaryAssetId ARTWorldSettings::GetDefaultGameplayExperience() const
{
...
#if WITH_EDITOR
void ARTWorldSettings::CheckForErrors()
{
	...
	for (TActorIterator<APlayerStart> PlayerStartIt(GetWorld()); PlayerStartIt; ++PlayerStartIt)
	{
		...
		if (IsValid(PlayerStart) && PlayerStart->GetClass() == APlayerStart::StaticClass())
		{
			MapCheck.Warning()
				...
				->AddToken(FTextToken::Create(FText::FromString("is a normal APlayerStart, replace with AASPlayerStart.")));
		}
	}
}
#endif